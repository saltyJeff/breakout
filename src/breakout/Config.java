...
public final class Config { //cuz static classes aren't a thing :P
	...
	public static final int RENDER_TICK = 1000/30;
	public static final int JPC = 60;
	public static final int MAX_BLOCK = 5;
	public static final Vector INITIAL_POS = new Vector(1,Config.BOARD_HEIGHT - 3);
	public static final Vector INITIAL_VEL = new Vector(1,1).multiply(6.2);
